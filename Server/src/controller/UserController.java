...
/**
 * the class implements all the methods defined in UserRepositoy 
 * 
 *    
 */
...
/**
 * the method is used to find a user 
 */
	@Override
	...
	/**
	 * the method is used to find a user by id
	 * @param	id of the user
	...
	/**
	 * the method is used to find a user by name
	...
	/**
	 * the method is used to insert a user 
	 * @param user	enter user details
	 * @return    
	 */
	@Override
	...
	/**
	 * the method is used to update a user 
	 * @param user	enter user details
	 * @return   
	 */
	@Override
	...
	/**
	 * the method is used count the number of users 
	 * 	
	 * @return count   
	 */
	@Override
	...
	/**
	 * the method is used to check whether the user exist  
